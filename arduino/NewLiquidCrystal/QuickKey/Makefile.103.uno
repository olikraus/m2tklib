...
M2DEV_PATH:=$(shell cd ../../.. && pwd)/dev/NewLiquidCrystal/
...
ARDUINO_PATH:=/home/kraus/prg/arduino-1.0.3-lc-i2c-m2tklib/
...
COMMON_FLAGS += -I. -I$(ARDUINO_PATH)libraries/LiquidCrystal
