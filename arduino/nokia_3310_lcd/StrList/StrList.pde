...
M2_STRLIST(el_strlist, "l4w12", &el_strlist_first, &el_strlist_cnt, el_strlist_getstr);
...
M2_LIST(list) = { &el_strlist, &el_vspace, &el_label_hlist };
M2_VLIST(el_vlist, NULL, list);
M2_ALIGN(top_el, "-1|1W64H64", &el_vlist);

M2tk m2(&top_el, m2_es_arduino, m2_eh_4bs, m2_gh_nokia_3310);
