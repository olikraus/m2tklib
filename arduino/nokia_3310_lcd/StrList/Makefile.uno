...
M2TKLIB_PATH:=/home/kraus/src/m2/m2tklib/src/
M2DEV_PATH:=/home/kraus/src/m2/m2tklib/dev/nokia_3310_lcd/
...
EXTRA_DIRS=$(ARDUINO_PATH)libraries/nokia_3310_lcd/
EXTRA_DIRS+=/home/kraus/src/m2/m2tklib/dev/arduino/
EXTRA_DIRS+=$(M2DEV_PATH)
...
CDIRS:=*.c utility/*.c $(M2TKLIB_PATH)*.c $(M2DEV_PATH)*.c $(addsuffix *.c,$(CDIRS)) $(ARDUINO_PATH)hardware/arduino/cores/arduino/*.c
...
COMMON_FLAGS += -I. -I$(M2TKLIB_PATH) -I$(M2DEV_PATH)
