...
// input values
uint8_t fc_pin = 5; 			// 3, 5, 11 (only OCRnB)
...
M2_LABEL(el_label3, "f1", "Real Freq.: ");
M2_U32NUM(el_real_freq, "r1c6f1", &fc_calc_freq);
M2_LABEL(el_label4, "f1", "Real Duty: ");
M2_U8NUM(el_real_duty, "r1c3f1",0, 255, &fc_calc_duty);
