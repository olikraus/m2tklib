/*
  generic/mmc.c renamed to pff_diskio.c, procedure calls added
*/
...
#define	CS_H()		pff_chip_select_high()	/* Set MMC CS "high" */
#define CS_L()		pff_chip_select_low()	/* Set MMC CS "low" */
