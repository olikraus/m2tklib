...
M2_EL_FN_DEF(m2_el_labelp_fn)
{
  ...
  switch(fn_arg->msg)
  {
    ...
    case M2_EL_MSG_GET_WIDTH:
      return m2_gfx_add_readonly_border_width(font, m2_align_get_max_width(fn_arg, m2_gfx_get_text_width_p(font,m2_el_str_get_str(fn_arg))));
    case M2_EL_MSG_SHOW:
      {
	...
	m2_gfx_draw_text_p_add_readonly_border_offset(b->x, b->y, 
